...
import 'package:boopbook/screens/news/story.dart';
import 'package:boopbook/screens/news/story_details.dart';
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      HomeCubit.get(context).comment[index].toString(),
                      style: Theme.of(context).textTheme.caption,
                    ),
                  ],
                ),
